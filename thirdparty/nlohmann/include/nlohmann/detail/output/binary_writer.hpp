...
private:
    ...
    */
    static std::size_t calc_bson_element_size(const string_t& name, const BasicJsonType& j)
    {
        ...
        case value_t::binary: return header_size + calc_bson_binary_size(*j.m_value.binary);
    ...
    */
    void write_bson_element(const string_t& name, const BasicJsonType& j)
    {
        ...
        case value_t::binary: return write_bson_binary(name, *j.m_value.binary);
        ...
        case value_t::number_unsigned: return write_bson_unsigned(name, j);
