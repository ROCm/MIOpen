...
public:
    ...
    static const char* token_type_name(const token_type t) noexcept
    {
        ...
        case token_type::value_float: return "number literal";
...
private:
    ...
    */
    ...
    scan_literal(const char_type* literal_text, const std::size_t length, token_type return_type)
    {
        ...
        {
            if(JSON_HEDLEY_UNLIKELY(std::char_traits<char_type>::to_char_type(get()) !=
                                    literal_text[i]))
            {
...
public:
    ...
    */
    ...
    token_type scan()
    {
        ...
        // string literals)
        case '\0':
        case std::char_traits<char_type>::eof(): return token_type::end_of_input;
