...
Please refer to the MIOpen installation instructions: [installing MIOpen kernels package](./install.md) for guidance on installing the MIOpen kernels package.
