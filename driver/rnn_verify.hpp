                ...
                for(int h = 0; h < hy_h; h++)
                {
                    if(li == 0)
                    {
                        ...
                        for(int w = 0; w < hy_h; w++)
                        {
                            ...
                            {
                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    wei[in_h * hy_stride + w * hy_stride + h] *
                                    hx[hx_shift + bs * hy_stride + w];
                            }
                            else
                            {
                                int pretime_shift =
                                    li * batch_n * hy_h * bi + (bacc - in_n[ti - 1]) * hy_stride;

                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    wei[in_h * hy_stride + w * hy_stride + h] *
                                    activfunc(hid_state[pretime_shift + bs * hy_stride + w],
                                              squash);
                            }
                        }
                    ...
                    else
                    {
                        ...
                        {
                            hid_state[hid_shift + bs * hy_stride + h] +=
                                wei[wei_shift + w * hy_stride + h] *
                                activfunc(hid_state[prelayer_shift + bs * hy_stride + w], squash);
                            if(bidirection)
                            {
                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    wei[wei_shift + (hy_h + w) * hy_stride + h] *
                                    activfunc(hid_state[prelayer_shift + bs * hy_stride + hy_h + w],
                                              squash);
                            }
                        }
                        ...
                        for(int w = 0; w < hy_h; w++)
                        {
                            ...
                            {
                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    wei[wei_shift + bi * hy_h * hy_stride + w * hy_stride + h] *
                                    hx[hx_shift + bs * hy_stride + w];
                            }
                            else
                            {
                    ...
                    hy_host[hx_shift + bs * hy_stride + h] =
                        activfunc(hid_state[hid_shift + bs * hy_stride + h], squash); // squash_func
                }
            }
            bacc += in_n[ti];
        }
                    ...
                    for(int h = 0; h < hy_h; h++)
                    {
                        if(li == 0)
                        {
                            ...
                            for(int w = 0; w < hy_h; w++)
                            {
                                ...
                                {
                                    hid_state[hid_shift + bs * hy_stride + h] +=
                                        wei[in_h * hy_stride + w * hy_stride + hy_h + h] *
                                        hx[hx_shift + bs * hy_stride + w];
                                }
                                else
                                {
                                    int pretime_shift = li * batch_n * hy_h * bi +
                            ...
                            {
                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    (wei[wei_shift_bias + hy_h + h] +
                                     wei[wei_shift_bias + hy_stride + hy_h + h]);
                            }
                        }
                        else
                        {
                            int wei_shift = bi * (in_h + hy_h) * hy_h +
                                            (li - 1) * bi * (bi * hy_h + hy_h) * hy_h + hy_h;
                            int prelayer_shift = (li - 1) * batch_n * hy_h * bi + bacc * hy_stride;
                            ...
                            for(int w = 0; w < hy_h; w++)
                            {
                                hid_state[hid_shift + bs * hy_stride + h] +=
                                    (wei[wei_shift + w * hy_stride + h] *
                                         activfunc(hid_state[prelayer_shift + bs * hy_stride + w],
                                                   squash) +
                                     wei[wei_shift + (hy_h + w) * hy_stride + h] *
                                         activfunc(
                            ...
                            for(int w = 0; w < hy_h; w++)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        hid_state[hid_shift + bs * hy_stride + h] +=
                                            wei[wei_shift + bi * hy_h * hy_stride + w * hy_stride +
                                                h] *
                                            activfunc(hid_state[pretime_shift + bs * hy_stride + w],
                                                      squash);
                                    }
                            ...
                            if(biased)
                            {
                                int wei_shift_bias_temp = wei_shift_bias + bi * 2 * hy_h +
                                                          bi * (li - 1) * (bi + 1) * hy_h + hy_h;
                        ...
                        hy_host[hx_shift + bs * hy_stride + h] = activfunc(
                            hid_state[hid_shift + bs * hy_stride + h], squash); // squash_func
                    }
                }
            }
        }
            ...
            for(int w = 0; w < out_h; w++)
            {
                for(int h = 0; h < hy_stride; h++)
                {
                    out_state[(bacc + bs) * out_stride + w] +=
                        wei[wei_shift + w * hy_stride + h] *
                        activfunc(hid_state[prelayer_shift + bs * hy_stride + h], squash);
                }
            ...
            for(int bs = 0; bs < in_n[ti]; bs++)
            {
                for(int h = 0; h < hy_h; h++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            dh_state[hid_shift + bs * hy_stride + h] +=
                                wei[wei_shift + h * hy_stride + w] *
                                dh_state[prelayer_shift + bs * hy_stride + w];
                            if(bidirection)
                            {
                                dh_state[hid_shift + bs * hy_stride + h] +=
                                    wei[wei_shift + h * hy_stride + hy_h + w] *
                                    dh_state[prelayer_shift + bs * hy_stride + hy_h + w];
                            }
                        }
                    }
                    ...
                    {
                        dh_state[hid_shift + bs * hy_stride + h] +=
                            dhy[hx_shift + bs * hy_stride + h];
                    }
                    else
                    {
                        dh_state[hid_shift + bs * hy_stride + h] +=
                            dhx_host[hx_shift + bs * hy_stride + h];
                    }

                    dh_state[hid_shift + bs * hy_stride + h] *=
                        dervactivfunc(rsvspace[hid_shift + bs * hy_stride + h], squash);
                }
                ...
                for(int h = 0; h < hy_h; h++)
                {
                    ...
                    for(int w = 0; w < hy_h; w++)
                    {
                        ...
                        dhx_host[hx_shift + bs * hy_stride + h] +=
                            wei[wei_shift + h * hy_stride + w] *
                            dh_state[hid_shift + bs * hy_stride + w];
                    }
                }
            }
        }
                ...
                for(int bs = 0; bs < in_n[ti]; bs++)
                {
                    for(int h = 0; h < hy_h; h++)
                    {
                        ...
                        if(li == numlayer - 1)
                        {
                            ...
                            {
                                dh_state[hid_shift + bs * hy_stride + h] +=
                                    wei[wei_shift + w * hy_stride + hy_h + h] *
                                    dout[(bacc + bs) * out_h + w];
                            }
                        }
                        else
                        {
                            ...
                            {
                                dh_state[hid_shift + bs * hy_stride + h] +=
                                    (wei[wei_shift + (h + hy_h) * hy_stride + w] *
                                         dh_state[prelayer_shift + bs * hy_stride + w] +
                                     wei[wei_shift + (h + hy_h) * hy_stride + hy_h + w] *
                                         dh_state[prelayer_shift + bs * hy_stride + hy_h + w]);
                            }
                        }
                    ...
                    for(int h = 0; h < hy_h; h++)
                    {
                        ...
                        for(int w = 0; w < hy_h; w++)
                        {
                            wei_shift = li == 0 ? (in_h * hy_stride + hy_h)
                                                : (bi * (in_h + hy_h) * hy_h +
                                                   (li - 1) * bi * (bi * hy_h + hy_h) * hy_h +
                                                   bi * hy_h * hy_stride + hy_h);
    ...
    for(int ti = 0; ti < seqLength; ti++)
    {
        for(int bs = 0; bs < in_n[ti]; bs++)
        {
            for(int w = 0; w < in_h; w++)
            {
                for(int h = 0; h < hy_stride; h++)
                {
                    din_state[(bacc + bs) * in_stride + w] +=
                        wei[w * hy_stride + h] * dh_state[(bacc + bs) * hy_stride + h];
                }
            }
        }
        bacc += in_n[ti];
                    ...
                    for(int w = 0; w < hy_h; w++)
                    {
                        for(int bs = 0; bs < in_n[ti]; bs++)
                        {
                            ...
                            if(bidirection)
                            {
                                if(ti == seqLength - 1)
                                {
                                    dwei_state[wei_shift + hy_h + h * hy_stride + w] +=
                                        hx[hx_shift + hy_h + bs * hy_stride + h] *
                                        wkspace[hid_shift + hy_h + bs * hy_stride + w];
                                }
                                else
                                {
                        ...
                        for(int bs = 0; bs < in_n[ti]; bs++)
                        {
                            dwei_state[wei_shift + h * hy_stride + w] +=
                                (dout[(bacc + bs) * out_stride + h] *
                                 activfunc(rsvspace[prehid_shift + bs * hy_stride + w], squash));
                        }
                    }
                }
            }
            else
            {
                ...
                for(int h = 0; h < hy_stride; h++)
                {
                    for(int w = 0; w < hy_stride; w++)
                    {
                        ...
                        {
                            dwei_state[wei_shift + h * hy_stride + w] +=
                                (activfunc(rsvspace[prehid_shift + bs * hy_stride + h], squash) *
                                 wkspace[hid_shift + bs * hy_stride + w]);
                        }
                    }
                }
                    ...
                    for(int w = 0; w < hy_h; w++)
                    {
                        for(int bs = 0; bs < in_n[ti]; bs++)
                        {
                            ...
                            if(bidirection)
                            {
                                if(ti == seqLength - 1)
                                {
                                    dwei_state[wei_shift + h * hy_stride + hy_h + w] +=
                                        hx[hx_shift + bs * hy_stride + hy_h + h] *
                                        wkspace[hid_shift + bs * hy_stride + hy_h + w];
                                }
                                else
                                {
                                    prehid_shift = li * bi * batch_n * hy_h +
                ...
                for(int h = 0; h < hy_stride; h++)
                {
                    for(int w = 0; w < batch_n; w++)
                    {
                        dwei_state[wei_shift_bias + h] +=
                            wkspace[li * bi * batch_n * hy_h + w * hy_stride + h];
                    }
