...
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 700 -H 161 -c 1 -n 4 -k 32 -x 5  -y 20 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 700 -H 161 -c 1 -n 8 -k 32 -x 5  -y 20 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 700 -H 161 -c 1 -n 16 -k 32 -x 5 -y 20 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 700 -H 161 -c 1 -n 32 -k 32 -x 5 -y 20 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 341 -H 79 -c 32 -n 4 -k 32 -x 5 -y 10 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 341 -H 79 -c 32 -n 8 -k 32 -x 5 -y 10 -p 0 -q 0 -u 2 -v 2
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 341 -H 79 -c 32 -n 16 -k 32 -x 5 -y 10 -p 0 -q 0 -u 2 -v 2rem 
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 341 -H 79 -c 32 -n 32 -k 32 -x 5 -y 10 -p 0 -q 0 -u 2 -v 2
...
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 28 -H 28 -c 192 -n 16 -k 64 -y 1 -x 1 -p 0 -q 0 -u 1 -v 1
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 14 -H 14 -c 512 -n 16 -k 48 -y 5 -x 5 -p 2 -q 2 -u 1 -v 1
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 14 -H 14 -c 512 -n 16 -k 192 -y 1 -x 1 -p 0 -q 0 -u 1 -v 1
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 7 -H 7 -c 832 -n 16 -k 256 -y 1 -x 1 -p 0 -q 0 -u 1 -v 1
rem ./driver/MIOpenDriver conv  -s 1 -V 0 -t 1 -F 1 -W 7 -H 7 -c 832 -n 16 -k 128 -y 5 -x 5 -p 2 -q 2 -u 1 -v 1
cd ..\src\ocl
