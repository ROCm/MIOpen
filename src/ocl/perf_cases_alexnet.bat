...
.\driver\Debug\MLOpenDriver.exe conv -i 1 -n %B% -W 13 -H 13 -c 256 -k 384 -x 3 -y 3 -p 1 -q 1 -F 1 -t %T% -s %S% -V %V%
echo "conv4 10x384x13x13x384x3x3"
.\driver\Debug\MLOpenDriver.exe conv -i 1 -n %B% -W 13 -H 13 -c 384 -k 384 -x 3 -y 3 -p 1 -q 1 -F 1 -t %T% -s %S% -V %V%
echo "conv5 10x384x13x13x256x3x3"
.\driver\Debug\MLOpenDriver.exe conv -i 1 -n %B% -W 13 -H 13 -c 384 -k 256 -x 3 -y 3 -p 1 -q 1 -F 1 -t %T% -s %S% -V %V%
:end
cd ../src/OCL