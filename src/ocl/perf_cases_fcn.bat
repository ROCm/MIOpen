...
.\driver\Debug\MLOpenDriver.exe conv -i 1 -t %T% -n %B%  -V %V% -W  128 -H 64 -c 832 -k 256 -x 1 -y 1 -p 0 -q 0  -F 1 -s 1
...
.\driver\Debug\MLOpenDriver.exe conv -i 1 -t %T% -n %B%  -V %V% -W  128 -H 64 -c 832 -k 384 -x 1 -y 1 -p 0 -q 0  -F 1 -s 1
