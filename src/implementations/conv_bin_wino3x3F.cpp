...
bool ConvBinWinograd3x3F::IsCorrect(const ImplementationSearchParameters& params) const
{
...
ConvBinWinograd3x3F::PrepareForUsage(const ImplementationSearchParameters& params,
