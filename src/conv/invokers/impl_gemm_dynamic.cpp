    ...
    const solver::PerformanceConfigAsmImplicitGemmGTCFwdXdlopsNHWC& config)
{
    ...
    const auto is_stochastic =
        problem.conv_problem.GetConv().attribute.fp8rounding_mode.Get() == miopenF8RoundingModeStochastic;
    ...
    if(is_nchw)
    {
        TransposeSolutionDefault2Nhwc trans_input(
            ...
            hi,
            wi,
            solver::GetImplGemmDynamicNHWCBatchedTransposeFlag(problem.conv_problem.GetInDataType(),
        ...
        TransposeSolutionDefault2Nhwc trans_weight(
            ...
            solver::GetImplGemmDynamicNHWCBatchedTransposeFlag(
                problem.conv_problem.GetWeightsDataType(), problem.conv_problem.GetWeightsCastType()),
            is_stochastic,
