...
#define CK_USE_VECTOR_LOAD_WITH_PADDING 0
#if CK_PARAM_PROBLEM_LEFT_PAD_H && CK_PARAM_TUNABLE_GEMM_B_BLOCK_COPY_SRC_DATA_PER_READ_GEMM
#undef CK_USE_VECTOR_LOAD_WITH_PADDING
#define CK_USE_VECTOR_LOAD_WITH_PADDING 1
#endif
