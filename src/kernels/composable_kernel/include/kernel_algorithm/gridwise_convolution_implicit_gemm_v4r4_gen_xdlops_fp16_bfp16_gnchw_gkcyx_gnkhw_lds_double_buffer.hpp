...
template <index_t GridSize,
          ...
          class InBlockCopySubLengths_G_E_B_EPACK,
          class InBlockCopyClusterLengths_G_E_B_EPACK,
          ...
          class WeiBlockCopySubLengths_G_E_K_EPACK,
          class WeiBlockCopyClusterLengths_G_E_K_EPACK,
    ...
    GridwiseConvolutionImplicitGemm_v4r4_gen_xdlops_fp16_bfp16_gnchw_gkcyx_gnkhw_lds_double_buffer
{
                        ...
                        Float* const __restrict__ p_out_global) const
    {
        ...
        constexpr auto in_g_e_b_epack_block_desc = make_native_tensor_descriptor_aligned(
            Sequence<1, EPerBlock, BPerBlock, EPack>{}, Number<max_align>{});

        // static_assert(in_g_e_b_epack_block_desc.GetStride(I0) % EPack * GemmDataPerReadB == 0,
        ...
        auto blockwise_in_copy = BlockwiseGenericTensorSliceCopy_v4<
            ...
            decltype(in_g_e_b_epack_block_desc),
            decltype(in_g_e_b_epack_block_desc.GetLengths()),
        ...
        constexpr auto wei_g_e_k_epack_block_desc = make_native_tensor_descriptor_aligned(
            Sequence<1, EPerBlock, KPerBlock, EPack>{}, Number<max_align>{});

        //     this check is ad-hoc
        //     TODO: need to properly implement tensor descriptor with multiple alignment
        //     requirements
        // static_assert(wei_g_e_k_epack_block_desc.GetStride(I0) % EPack * GemmDataPerReadA == 0,
        ...
        constexpr index_t in_block_space =
            math::integer_least_multiple(in_g_e_b_epack_block_desc.GetElementSpace(), max_align);
        ...
        using blockwise_wei_copy_src_step = Sequence<0, EPerBlock, 0, 0>;
