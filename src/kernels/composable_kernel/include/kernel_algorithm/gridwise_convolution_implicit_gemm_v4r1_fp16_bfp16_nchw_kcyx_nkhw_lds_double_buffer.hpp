...
struct make_wei_e_k_epack_global_desc_v4r1
{
...
struct make_wei_e_k_epack_global_desc_v4r1<EPack, ConvolutionDirection::BackwardWeight>
{
    template <typename WeiDesc>
    __device__ constexpr auto operator()(WeiDesc) const
    {
...
struct GridwiseConvolutionImplicitGemm_v4r1_fp16_bfp16_nchw_kcyx_nkhw_lds_double_buffer
{
                        ...
                        Float* const __restrict__ p_out_global) const
    {
        ...
        constexpr auto in_n0_n1_n2_epack_c_y_ho_x_wo_global_desc = transform_tensor_descriptor(
            ...
            make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{}),
            make_tuple(Sequence<0, 1, 2>{}, Sequence<3, 4>{}, Sequence<5, 6>{}, Sequence<7, 8>{}));

        constexpr auto in_e_n1_b_n2_epack_global_desc = transform_tensor_descriptor(
            in_n0_n1_n2_epack_c_y_ho_x_wo_global_desc,
        ...
        // Because buffer_load is not supported for fp16/bfp16, choose
        ...
        using blockwise_in_copy_slice_window  = Sequence<EPerBlock, 0, 0, 0, 0>;
        using blockwise_wei_copy_slice_window = Sequence<EPerBlock, 0, 0>;
