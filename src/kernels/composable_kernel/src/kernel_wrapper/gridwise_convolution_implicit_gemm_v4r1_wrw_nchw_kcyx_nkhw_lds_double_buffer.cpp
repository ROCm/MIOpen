...
#include "gridwise_convolution_implicit_gemm_v4r1_wrw_nchw_kcyx_nkhw_lds_double_buffer.hpp"
#include "float_types.h"

extern "C" __global__
    __launch_bounds__(CK_PARAM_TUNABLE_BLOCK_SIZE, 2) void gridwise_convolution_implicit_gemm_v4r1_wrw_nchw_kcyx_nkhw_lds_double_buffer(
        ...
        FLOAT* const __restrict__ p_out_global)
{
    ...
    constexpr index_t EBlocks = CK_PARAM_TUNABLE_E_BLOCKS;
...
#if MIOPEN_USE_FP32
        GridwiseConvolutionImplicitGemm_v4r1_wrw_nchw_kcyx_nkhw_lds_double_buffer<
            GridSize,
            BlockSize,
            FLOAT,
            FLOAT_ACCUM,
