...
extern "C" __global__
    __launch_bounds__(CK_PARAM_TUNABLE_BLOCK_SIZE, 2) void gridwise_convolution_backward_data_implicit_gemm_v4r1_ncdhw_kczyx_nkdhw(
        ...
        FLOAT* const __restrict__ p_in_global)
{
    ...
    constexpr auto gridwise_conv_bwd_data =
        GridwiseConvolutionBackwardDataImplicitGemm_v4r1_ncdhw_kczyx_nkdhw<
            GridSize,
            BlockSize,
            FLOAT,
            FLOAT_ACCUM,
