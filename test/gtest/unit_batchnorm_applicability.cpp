...
std::vector<ApplicabilityParams> GetParams()
{
    ...
    {
        params.push_back({dt, dt, miopenFloat, miopenFloat, miopenFloat, miopenFloat, true,
                          "X_Y_" + GetDataType(dt) + "_Stats_" + GetDataType(miopenFloat)});
    }
    // Invalid: X & Y are invalid types
    params.push_back({miopenInt8, miopenInt8, miopenFloat, miopenFloat, miopenFloat, miopenFloat,
                      false, "X_INT8_Y_INT8"});
    params.push_back({miopenInt32, miopenInt32, miopenFloat, miopenFloat, miopenFloat, miopenFloat,
                      false, "X_INT32_Y_INT32"});
    // Invalid: X & Y are mixed
    params.push_back({miopenFloat, miopenHalf, miopenFloat, miopenFloat, miopenFloat, miopenFloat, false, "X_FP32_Y_FP16"});
    params.push_back({miopenHalf, miopenBFloat16, miopenFloat, miopenFloat, miopenFloat, miopenFloat, false, "X_FP16_Y_BFP16"});
    params.push_back({miopenBFloat16, miopenFloat, miopenFloat, miopenFloat, miopenFloat, miopenFloat, false, "X_BFP16_Y_FP32"});
    // Invalid: stats not FP32
    params.push_back({miopenFloat, miopenFloat, miopenHalf, miopenFloat, miopenFloat, miopenFloat, false, "Scale_FP16"});
    params.push_back({miopenFloat, miopenFloat, miopenFloat, miopenHalf, miopenFloat, miopenFloat, false, "Bias_FP16"});
    params.push_back({miopenFloat, miopenFloat, miopenFloat, miopenFloat, miopenHalf, miopenFloat, false, "Mean_FP16"});
    params.push_back({miopenFloat, miopenFloat, miopenFloat, miopenFloat, miopenFloat, miopenHalf, false, "Var_FP16"});
    // Invalid: all stats not FP32
    params.push_back({miopenHalf, miopenHalf, miopenHalf, miopenHalf, miopenHalf, miopenHalf, false, "AllStats_FP16"});
    return params;
}
...
TEST_P(CPU_BatchNormFwdTrainingSpatialApplicabilityTest_NONE, IsApplicable)
{
    ...
    ProblemDescription problem(
        miopenBNSpatial, xDesc, yDesc, scaleDesc, biasDesc, meanDesc, varDesc,
        1.0, 1e-5, true, true, 1, actDesc);
...
TEST_P(CPU_BatchNormFwdTrainingPerActivationApplicabilityTest_NONE, IsApplicable)
{
    ...
    ProblemDescription problem(
        miopenBNPerActivation, xDesc, yDesc, scaleDesc, biasDesc, meanDesc, varDesc,
        1.0, 1e-5, true, true, 1, actDesc);
...
TEST_P(CPU_BatchNormBwdTrainingSpatialApplicabilityTest_NONE, IsApplicable)
{
    ...
    ProblemDescription problem(
        miopenBNSpatial, xDesc, dyDesc, dxDesc, scaleDesc, biasDesc, meanDesc, varDesc,
        1e-5, false, 1, actDesc);
...
TEST_P(CPU_BatchNormBwdTrainingPerActivationApplicabilityTest_NONE, IsApplicable)
{
    ...
    ProblemDescription problem(
        miopenBNPerActivation, xDesc, dyDesc, dxDesc, scaleDesc, biasDesc, meanDesc, varDesc,
        1e-5, false, 1, actDesc);
