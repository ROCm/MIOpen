        ...
        stage("Full tests II"){
            parallel{
                ...
                stage('FP32 gfx908 Hip Debug All subset') {
                    agent{ label rocmnode("gfx908") }
                    steps{
                        buildJob('hcc', '-DMIOPEN_TEST_GFX908=On -DBUILD_DEV=On -DMIOPEN_TEST_ALL=On -DMIOPEN_TEST_LIMIT=3 -DCMAKE_BUILD_TYPE=release', image + "rocm", "/opt/rocm")
                    }
                }
            }
        }
        ...
        stage("Full tests III"){
            parallel{
                ...
                stage('Half Hip Release All') {
                    agent{ label rocmnode("vega20") }
                    steps{
                        buildJob('hcc', '-DMIOPEN_TEST_HALF=On -DBUILD_DEV=On -DMIOPEN_TEST_ALL=On -DMIOPEN_TEST_LIMIT=3 -DCMAKE_BUILD_TYPE=release', image + "rocm", "/opt/rocm")
                    }
                }
                ...
                stage('Half gfx908 Hip Release All Subset') {
                    agent{ label rocmnode("gfx908") }
                    steps{
                        buildJob('hcc', '-DMIOPEN_TEST_HALF=On -DMIOPEN_TEST_GFX908=On -DBUILD_DEV=On -DMIOPEN_TEST_ALL=On -DMIOPEN_TEST_LIMIT=3 -DCMAKE_BUILD_TYPE=release', image + "rocm", "/opt/rocm")
                    }
                }
            }
        }
