...
pipeline {
    ...
    stages{
        ...
        stage("Smoke MIOpenTensile Latest"){
            ...
            parallel{
                stage('Fp16 Hip Tensile-Latest Smoke Vega20') {
                    agent{ label rocmnode("vega20") }
                    steps{
                ...
                stage('Int8 Hip Tensile-Latest Smoke Vega20') {
                    agent{ label rocmnode("vega20") }
                    steps{
                ...
                stage('Fp32 Hip Tensile-Latest Smoke gfx908') {
                    agent{ label rocmnode("gfx908") }
                    steps{
                ...
                stage('Bf16 Hip Tensile-Latest Smoke gfx908') {
                    agent{ label rocmnode("gfx908") }
                    steps{
                ...
                stage('Fp32 Hip Tensile-Latest Smoke gfx90a') {
                    agent{ label rocmnode("gfx90a") }
                    steps{
                ...
                stage('Bf16 Hip Tensile-Latest Smoke gfx90a') {
                    agent{ label rocmnode("gfx90a") }
                    steps{
